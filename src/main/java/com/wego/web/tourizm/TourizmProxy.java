...
public class TourizmProxy {
	...
	public List<String> writeSPOT() {
		List<String> spot = Arrays.asList("서울특별시 종로구 세종로 사직로 161","서울특별시 용산구 용산2가동 남산공원길 105","서울특별시 중구 명동",
				...
				"서울 강남구 테헤란로113길 7 백제예술대학 아트센터","서울 강남구 선릉로158길 3 Ys Roo","서울 강남구 도산대로45길 20 도산전시관");
		return spot;
	}
	
	public List<String> writeTOURIZMINFO() {
		List<String> tourizmInfo = Arrays.asList("궁궐 한복체험 박물관 고즈넉한공연","케이블카 야경투어 전망대 화려한 성곽길","먹거리 볼거리 데이트코스",
				...
				"데이트 힐링 나들이 소극장","무한도전 출연 휴식 체험관","나들이");
		return tourizmInfo;
	}
