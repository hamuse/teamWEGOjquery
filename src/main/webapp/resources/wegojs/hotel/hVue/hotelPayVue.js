...
hotelPayVue = {
		hPay_body: x=>{
			...
			/*'			<a id="kakaoPay" href="/payment/index#카카오페이"><img src="/web/resources/wegoimg/hotel/payment_icon_yellow_medium.png" alt=""></a>'+
			'<form id="kakao" method="post" action="/kakaoPay">'+
			'    <button id="kakao" value="https://mockup-pg-web.kakao.com/v1/1b2edb3020586d631c6f1fc35fed6ea2dbf6bbb715f854cdb59ef6a991b6ce1c/info">카카오페이로 결제하기</button>'+
			'</form>'+*/
