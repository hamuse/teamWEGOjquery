...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.3.1/jquery.min.js"></script>
	<!-- <script type="text/javascript" src=""></script>kakaoapi -->
...
<script src="<%=application.getContextPath()%>/resources/wegojs/hotel/hDate/the-datepicker.css"></script>
<script src="<%=application.getContextPath()%>/resources/wegojs/hotel/hDate/the-datepicker.js"></script>
